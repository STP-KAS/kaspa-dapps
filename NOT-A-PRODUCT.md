...
Honest work that remains: receipts, tills that quote fiat and settle native KAS, dual-rail freeze labs, public-goods pins. Those are not dapps in the DeFi sense. Do not round them up.

Desk prompt: [kaspa-master-file/DESK-PROMPT.md](https://github.com/STP-KAS/kaspa-master-file/blob/main/DESK-PROMPT.md).
